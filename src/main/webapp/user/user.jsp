										...
										.confirm(
												...
												function(r) {
													if (r) {
														...
														window.location = "./UserServlet?cmd=deleteUsers&ids="
																+ ids.get();
													}
												});
							}
...
<script type="text/javascript">
	function checkAll(obj) {
		$("input[name='ck']").attr("checked", obj.checked);
	}
</script>
...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<!-- 查询区  -->
		<form action="./UserServlet?cmd=searchUser" method="post">
		<tr valign="top">
			<td height="30">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="font3">用户名：<input type="text" name="username">
										...
										id="delete" type="button" value="删除" />
									</td>
								</tr>
							</table>
					...
					<tbody>
						...
						<c:forEach items="${userList }" var="user">
							<tr id="data_0" align="center" class="main_trbg"
								...
								<td><input type="checkbox" id="box_0" name="ck"
									value="${user.id}"></td>
								...
								<td align="center" width="40px;"><a
									href="user/showUpdateUser.jsp?loginname=${user.loginname}&status=${user.status}&username=${user.username}&id=${user.id}"> <img title="修改"
										src="./images/update.gif"></a></td>
						...
						<!-- 					<td><input type="checkbox" id="box_1" value="5"></td> -->
						<!-- 					 <td>wangxh</td> -->
						...
						<!-- 					 <td align="center" width="40px;"><a href="showUpdateUser.jsp"> -->
					...
					<tbody>
						...
						<tr>
							<td
								...
								color="red">2</font>条记录，当前显示1-2条记录。
							</td>
						</tr>
					</tbody>
				</table>
