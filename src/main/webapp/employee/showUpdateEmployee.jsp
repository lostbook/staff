...
<script type="text/javascript">
	$(function() {
		...
		if ("${param.job_id}" == 9) {
			document.getElementById("job_id").value = "9";
		} else if ("${param.job_id}" == 8) {
			document.getElementById("job_id").value = "8";
		} else if ("${param.job_id}" == 7) {
			document.getElementById("job_id").value = "7";
		} else if ("${param.job_id}" == 6) {
			document.getElementById("job_id").value = "6";
		} else if ("${param.job_id}" == 5) {
			document.getElementById("job_id").value = "5";
		} else if ("${param.job_id}" == 4) {
			document.getElementById("job_id").value = "4";
		} else if ("${param.job_id}" == 3) {
			document.getElementById("job_id").value = "3";
		} else if ("${param.job_id}" == 2) {
			document.getElementById("job_id").value = "2";
		} else {
			document.getElementById("job_id").value = "1";
		}

		if ("${param.dept_id}" == 6) {
			document.getElementById("dept_id").value = "6";
		} else if ("${param.dept_id}" == 5) {
			document.getElementById("dept_id").value = "5";
		} else if ("${param.dept_id}" == 4) {
			document.getElementById("dept_id").value = "4";
		} else if ("${param.dept_id}" == 3) {
			document.getElementById("dept_id").value = "3";
		} else if ("${param.dept_id}" == 2) {
			document.getElementById("dept_id").value = "2";
		} else {
			document.getElementById("dept_id").value = "1";
		}
	})
</script>
</head>
<body>
	...
	<form id="employeeForm" action="/staff/EmployeeServlet?cmd=updateEmployee&id=${param.id }" method="post">
						...
						<tbody>
							<tr valign="top">
								<td>
									...
									value="2"> <input type="hidden" name="id" value="1">
										...
										<tbody>
														...
														<tbody>
															<tr>
																<td class="font3 fftd">姓名：<input type="text"
																	name="name" id="name" size="20" value="${param.name}"></td>
																<td class="font3 fftd">身份证号码：<input type="text"
																	name="card_id" id="cardId" size="20"
																	value="${param.card_id }"></td>
															</tr>
															<tr>
																<td class="font3 fftd">性别： <select id="sex"
																	name="sex" style="width: 143px;">
															...
															<tr>
																<td class="font3 fftd">学历：<input name="education"
																	id="education" size="20" value="${param.education }"></td>
															...
															<tr>
																<td class="font3 fftd">手机：<input name="phone"
																	id="phone" size="20" value="${param.phone }"></td>
																<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input
																	name="tel" id="tel" size="20" value="${param.tel }"></td>
															</tr>
											...
											<tr>
												<td class="font3 fftd">政治面貌：<input name="party"
													id="party" size="40" value="${param.party }">&nbsp;&nbsp;
											...
											<tr>
												<td class="font3 fftd">联系地址：<input name="address"
													id="address" size="40" value="${param.address }">&nbsp;&nbsp;
													邮政编码：<input name="post_code" id="postCode" size="20"
													value="${param.post_code }">
												</td>
											</tr>
											<tr>
												<td class="main_tdbor"></td>
											...
											<tr>
												<td class="font3 fftd">所学专业：<input name="speciality"
													id="speciality" size="40" value="${param.speciality}">&nbsp;&nbsp;
													爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="hobby" id="hobby"
													size="20" value="${param.hobby }">
												</td>
											</tr>
											<tr>
												<td class="main_tdbor"></td>
											...
											<tr>
												<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
													...
													value="${param.remark }"> &nbsp;&nbsp;所属部门： <select
													id="dept_id" name="dept_id" style="width: 100px;">
