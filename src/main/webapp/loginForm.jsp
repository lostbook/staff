				...
				<div class="input_text" >   
					...
					<form action="${pageContext.request.contextPath}/UserServlet?cmd=login" method="post">
						<div class="content" >
					        ...
					        <div >
					        	<button type="submit" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
					       	    <button type="button" title="刷脸登录" data-search-open="" data-title="刷脸登录" modal-toggle="modal" data-href="face/face.jsp" data-width="780" data-height="500" class="layui-btn  btn-login"  style="width:150px">&nbsp;&nbsp;刷    脸&nbsp;&nbsp;</button>
						    </div> 
