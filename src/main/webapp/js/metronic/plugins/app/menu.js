...
function loadMenu(){
	...
	+'"childs": [{"id": "11","name": "用户管理","icon": "/xingxing.png","url": "user/user.jsp","parentId": "1",'
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "UserServlet?cmd=userList","parentId": "11",'
	+'"childs": []},{"id": "112","name": "添加用户","icon": "","url": "user/showAddUser.jsp","parentId": "11",'
	+'"childs": []}]},{"id": "12","name": "部门管理","icon": "/xingxing.png","url": "dept/dept.jsp","parentId": "1",'
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "DepartmentServlet?cmd=departmentList","parentId": "12",'
	...
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "JobServlet?cmd=jobList","parentId": "14",'
	+'"childs": []},{"id": "142","name": "添加职位","icon": "","url": "job/showAddJob.jsp","parentId": "14",'
	+'"childs": []}]},{"id": "15","name": "员工管理","icon": "/xingxing.png","url": "employee/employee.jsp","parentId": "1",'
	+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "EmployeeServlet?cmd=employeeList","parentId": "15",'
	+'"childs": []},{"id": "152","name": "添加员工","icon": "","url": "employee/showAddEmployee.jsp","parentId": "15",'
	+'"childs": []}]},{"id": "16","name": "公告管理","icon": "/xingxing.png","url": "notice/notice.jsp","parentId": "1",'
	+'"childs": [{"id": "161","name": "公告查询","icon": "","url": "NoticeServlet?cmd=noticeList","parentId": "16",'
	+'"childs": []},{"id": "162","name": "添加公告","icon": "","url": "notice/showAddNotice.jsp","parentId": "16",'
	+'"childs": []}]},{"id": "17","name": "下载中心","icon": "/xingxing.png","url": "document/document.jspl","parentId": "1",'
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "DocumentServlet?cmd=documentList","parentId": "17",'
	+'"childs": []},{"id": "172","name": "上传文档","icon": "","url": "document/showAddDocument.jsp","parentId": "17","childs": []}]}]}]';
	// jquery的方法
