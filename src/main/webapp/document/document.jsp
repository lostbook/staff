	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					  ...
	 					  window.location="/staff/DocumentServlet?cmd=deleteDocument&ids="+ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  <!-- 查询区  -->
	  <form action="/staff/DocumentServlet?cmd=searchDocument" method="post">
	  <tr valign="top">
	    <td height="30">
		    ...
		    <c:forEach items="${documentList }" var="document">
				<tr ondblclick="down(7);" class="main_trbg" align="center" id="data_0" style="background-color: rgb(255, 255, 255);">
					<td><input type="checkbox" id="box_0" value="${document.id }"></td>
					 ...
					 <td align="center" width="40px;"><a href="./document/showUpdateDocument.jsp?id=${document.id}&title=${document.title}&remark=${document.remark }&filename=${document.filename }">
